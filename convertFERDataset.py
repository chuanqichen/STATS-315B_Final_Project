""" Credits: adapted from https://github.com/khemsok/facialexpressiondetector.git """
...
def convert_pixel_str_to_img(pixel_str):
  ...
  img = Image.fromarray(img_as_ubyte(pixel_arr)).convert('RGB')
  return img

def convert_fer_to_img():
  """Convert FER data to PNGs"""
  FER_PATH = './data/FER-2013/train.csv'
  ...
  root_data_dir = './data/FER-2013/images'
